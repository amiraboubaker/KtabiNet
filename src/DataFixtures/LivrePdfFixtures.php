...
class LivrePdfFixtures extends Fixture
{
    public function load(ObjectManager $manager): void
    {
       ...
       $book1->setUrlPdf('https://z-lib.io/book/17937053');
       $book1->setUrlImage('https://covers.openlibrary.org/b/id/12886417-L.jpg');
       ...
       $book2->setUrlPdf('https://z-lib.io/book/14586395');
       $book2->setUrlImage('https://m.media-amazon.com/images/I/716E6dQ4BXL._AC_UF1000,1000_QL80_.jpg');
       ...
       $book3->setUrlPdf('https://z-lib.io/book/17870009');
       $book3->setUrlImage('https://images.epagine.fr/is/5449/9780062457714_1_75.jpg');
       ...
       $manager->flush();
        ...
        $book4->setUrlPdf('https://z-lib.io/book/17661514'); 
        $book4->setUrlImage('https://images-na.ssl-images-amazon.com/images/S/compressed.photo.goodreads.com/books/1590806892i/53642699.jpg'); 
        ...
        $book5->setUrlPdf('https://z-lib.io/book/16038891'); 
        $book5->setUrlImage('https://m.media-amazon.com/images/I/71z70m5r7OL._AC_UF1000,1000_QL80_.jpg'); 
